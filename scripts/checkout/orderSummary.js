import { cart, removeFromCart, updateCartQuantity, calculateCartQuantity, updateDeliveryOption } from "../../data/cart.js";
...
export function renderOrderSummary(){
  ...
  document.querySelectorAll('.js-update-link').forEach((link) => {
    link.addEventListener('click', ()=> {
      ...
      container.classList.add('is-visible-edit');
    });
  });
  ...
  function updateCheckoutItem(productId){
    const container = document.querySelector(`.js-cart-item-${productId}`);
    container.classList.remove('is-visible-edit');
